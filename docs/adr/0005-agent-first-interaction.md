...
架构反转（[ADR 0008](0008-kernel-bin-ui-optional.md)）把「宿主 GUI 一定在」这条隐含前提拆了，原第 4 条随之重设计。用户 2026-08-04 现场面试五问逐条拍板（决策原文：`.scratch/kernel-bin-recharter/issues/05-dangerous-confirm-redesign.md`），改动如下：
